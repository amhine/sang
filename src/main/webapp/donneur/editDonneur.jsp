        ...
        <div class="col-lg-10">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-danger mb-0">
                    <i class="bi bi-pencil-square me-2 blood-drop"></i> Modifier le Donneur
                </h2>
                <a href="${pageContext.request.contextPath}/listDonneurs" class="btn btn-outline-danger">
                    ...
                    <form action="${pageContext.request.contextPath}/editDonneur" method="post">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="tel" name="telephone" class="form-control" value="${donneur.telephone}" pattern="^0[5-7][0-9]{8}$" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-bold">Poids (kg) <i class="bi bi-ui-checks text-muted"></i></label>
                                <input type="number" name="poids" class="form-control" value="${donneur.poids}" min="40" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h4 class="text-danger section-header">
                                    <i class="bi bi-heart-pulse me-2 health-icon"></i> Informations Médicales
                                </h4>
                                <hr class="border-danger">
                                <small class="text-muted">Cochez les conditions applicables (Oui = présence de la condition)</small>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hepatiteB" value="true" id="hepatiteB" ${donneur.medical.hepatiteB ? 'checked' : ''}>
                                    <label class="form-check-label fw-bold" for="hepatiteB">
                                        Hépatite B <i class="bi bi-exclamation-triangle warning-icon"></i>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hepatiteC" value="true" id="hepatiteC" ${donneur.medical.hepatiteC ? 'checked' : ''}>
                                    <label class="form-check-label fw-bold" for="hepatiteC">
                                        Hépatite C <i class="bi bi-exclamation-triangle warning-icon"></i>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="vih" value="true" id="vih" ${donneur.medical.vih ? 'checked' : ''}>
                                    <label class="form-check-label fw-bold" for="vih">
                                        VIH <i class="bi bi-shield-exclamation warning-icon"></i>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="diabete" value="true" id="diabete" ${donneur.medical.diabete ? 'checked' : ''}>
                                    <label class="form-check-label fw-bold" for="diabete">
                                        Diabète <i class="bi bi-capsule warning-icon"></i>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="grossesse" value="true" id="grossesse" ${donneur.medical.grossesse ? 'checked' : ''}>
                                    <label class="form-check-label fw-bold" for="grossesse">
                                        Grossesse <i class="bi bi-heart-fill warning-icon"></i>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="allaitement" value="true" id="allaitement" ${donneur.medical.allaitement ? 'checked' : ''}>
                                    <label class="form-check-label fw-bold" for="allaitement">
                                        Allaitement <i class="bi bi-baby warning-icon"></i>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="${pageContext.request.contextPath}/listDonneurs" class="btn btn-outline-secondary px-5 py-2">
