        ...
        <div class="col-lg-10">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-danger mb-0">
                    <i class="bi bi-plus-circle-fill me-2 blood-drop"></i> Formulaire de Donneur
                </h2>
                <a href="${pageContext.request.contextPath}/listDonneurs" class="btn btn-outline-danger">
                    <i class="bi bi-list-ul me-2"></i> Liste des Donneurs
                </a>
            </div>
                    ...
                    <form action="${pageContext.request.contextPath}/createDonneur" method="post">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="tel" name="telephone" class="form-control" pattern="^0[5-7][0-9]{8}$" placeholder="Ex: 0612345678" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="poids" class="form-control" min="40" placeholder="Ex: 70" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <hr class="border-danger">
                                <small class="text-muted">Sélectionnez les conditions applicables (Oui = présence de la condition)</small>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hepatiteB" value="true" id="hepatiteB">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="hepatiteC" value="true" id="hepatiteC">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="vih" value="true" id="vih">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="diabete" value="true" id="diabete">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="grossesse" value="true" id="grossesse">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="allaitement" value="true" id="allaitement">
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-danger px-5 py-2 me-3">
                                <i class="bi bi-save me-2"></i> Enregistrer le Donneur
                            </button>
